...
public class Boss extends FighterPlane {
	...
	public Boss() {
		...
		shieldImage = new ShieldImage(INITIAL_X_POSITION, INITIAL_Y_POSITION); // Set it to the same position with boss
	}
	...
	public void updatePosition() {
		...
		// adjust shield position to be the same with the boss
